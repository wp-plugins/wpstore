...
if($freteGratis == false){ 
 ...
 if( $peso>=30){
    ...
    $SEDEX = "  <input type='radio'  name='radioFrete' class='radioFrete'    rel='Sedex' id='Sedex' value='".$valorSedex."' />   $sedexNome : $moedaCorrente <span  class='red'  id='valorFreteSEDEX' >".$valorSedex."</span>  <br/>  $sedexPrazos. <hr/> ";   
