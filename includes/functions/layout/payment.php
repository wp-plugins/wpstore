...
<?php
	...
	$url = get_bloginfo('url')."/enviar-arquivos/";
	
	$txtPrint .= "<p class='btPaginaEnviar'><a href='$url' target='_blank'>Após o pagamento, Clique Aqui para enviar os arquivos personalizados para impressão  e produção de seus pedidod</a></p>";
