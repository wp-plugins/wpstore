   ...
   ?>
     ...
     <div class="desc">
         ...
         ?>
           ...
           <p class="price">R$ <?php echo custom_get_price($post->ID); //PLUGIN SHOP FUNCTION --------------------------------------  ?></p>
             ...
             <?php 
                ...
                ?>
                  ...
                  <dd><span class="priceDesc">R$ <?php echo $preco; ?>  </span> <?php //echo $categoriaPrincipalName2; ?>  <?php //echo $categoriaPrincipalName3; ?> </dd>
